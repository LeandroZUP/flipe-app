...
import br.com.zup.flipeapp.data.model.veiculo.VeiculoResponse
...
interface FipeAPI {
    ...
    suspend fun getAnos(@Path("modelos") codAno: Int): AnoResponse

    @GET("marcas/{marcas}/modelos/{modelos}/anos/{anos}/")
    suspend fun getVeiculo(@Path("anos") codigoFipe: String): VeiculoResponse
}